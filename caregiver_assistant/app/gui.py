...
#caregiver button gives option to view completed tasks
...
def open_task_input_form(patient_name):
    ...
    categories= {
        ...
        "Creative Activities":["Listen to music", "Look at family photos", "Play a card game", "Do a puzzle", "Read a book", "Watch a move","Other"],
